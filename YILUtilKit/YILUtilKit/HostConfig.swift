...
public  enum HostConfig : String {
    ...
    public var url: String {
        ...
        case .heBei:
            return appTestMode ? "" : ""
        case .jiangSu:
            return appTestMode ? "JSCN" : "http://oss.js96296.com:7005/mobile/webservice/commonRs/"
        case .linYi:
            return appTestMode ? "测试 url" : "http://219.146.196.73:65011/OSS/webservice/commonRs/"
        case .riZhao:
            return appTestMode ? "RiZhao" : "http://192.168.10.88:8099/OSS/webservice/commonRs/"
        case .deZhou:
            return appTestMode ? "测试 url" : "http://58.56.242.90:8088/OSS/webservice/commonRs/"
        case .maAnShan:
            return appTestMode ? "maAnShan" : "http://211.141.224.40:8090/OSS/webservice/commonRs/"
        }
    }
}
