...
//            var cityid: String = ""
            ...
            if isChinese {
                state = state?.substring(to: cityname.index(cityname.startIndex, offsetBy: cityname.characters.count - 1))
                cityname = cityname.substring(to: cityname.index(cityname.startIndex, offsetBy: cityname.characters.count - 1))
